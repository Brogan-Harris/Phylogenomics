# Script to remove all paralogs from all orthogroups in a directory.
# Will remove any all genes found in mutiple copy.
# Written by Brogan Harris - 05/08/2019.
# Note: Functions are avoided for speed.
...
print(""" Dependencies: Biopython, Matplotlib, Pandas, Seaborn
          ...
          Format:  All files suffix *.fa, all species "Arabidopsis_thaliana"
      """)
...
print("\n**** Thanks for using Paralog remover *****")
